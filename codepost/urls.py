...
urlpatterns = [
    ...
    re_path(r'^ott/generate/(?P<username>\w+)', generate_one_time_token, name='generate_one_time_token'),
    re_path(r'^ott/validate/(?P<token>[-A-Za-z0-9_.]+)/$', validate_one_time_token, name='validate_one_time_token'),
