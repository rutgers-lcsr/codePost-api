...
urlpatterns = [
    ...
    path('ott/generate/(?P<username>\w+)', generate_one_time_token, name='generate_one_time_token'),
    path('ott/validate/(?P<token>\w+)', validate_one_time_token, name='validate_one_time_token'),
