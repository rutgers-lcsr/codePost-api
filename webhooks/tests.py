...
# from webhooks.admin import HookForm
...
#     @patch('webhooks.models.client.post', autospec=True)
...
#     @patch('webhooks.models.client.post')
...
#         from webhooks.signals import raw_hook_event
...
#     @override_settings(HOOK_CUSTOM_MODEL='webhooks.models.Hook')
...
#         from webhooks.models import AbstractHook
