...
vinay = User.objects.create(username='vinay@codepost.io', email='vinay@codepost.io', password="rootabega")
vinay.profile.organization = princeton
richard.profile.organization = princeton
vinay.profile.organization = princeton
vinay.profile.canCreateCourses=True
richard.profile.canCreateCourses=True
vinay.profile.canCreateCourses=True
vinay.profile.canModifyRosters=True
...
for i in range(0, 5):
  username = "user" + str(i) + "@princeton.edu"
...
for i in range(0, 2):
  ...
  rubricComment3 = RubricComment.objects.create(text='Need more comments1', pointDelta=3, category=rubricCategory)
  rubricComment4 = RubricComment.objects.create(text='Need more comments2', pointDelta=3, category=rubricCategory)
  rubricComment5 = RubricComment.objects.create(text='Need more comments3', pointDelta=3, category=rubricCategory)
  ...
  rubricComment4 = RubricComment.objects.create(text='Need more comments4', pointDelta=3, category=rubricCategory2)
  rubricComment5 = RubricComment.objects.create(text='Need more comments5', pointDelta=3, category=rubricCategory2)
