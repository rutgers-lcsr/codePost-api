    ...
    static String toJson(Object o) {
        ...
        if (o instanceof TestResult) {
            ...
            return String.format(
                    ...
                    toJson(tr.name), toJson(tr.description), toJson(tr.message), toJson(tr.score), toJson(tr.max_score),
                    toJson(tr.passed),
...
public class TestRunner {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Test script crashed at class/runtime level — emit synthetic error result
            System.err.println("Test Script Error: " + t.toString());
            t.printStackTrace(System.err);
            TestResult crash = new TestResult("Test Script Execution", 0, "");
            crash.status = "error";
            crash.error = "Test script failed to load: " + t.toString();
            results.add(crash);
        }
